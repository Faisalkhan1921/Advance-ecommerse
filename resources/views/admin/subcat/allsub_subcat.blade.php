        ...
        <div class="col-3 mt">
            ...
            <div class="box">
               ...
               <div class="container-fluid mt-3">
                <form action="{{route('store.sub_subcat')}}" method="post"  >
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="sub_subcategory_name_hindi"  class="form-control">
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input type="submit" value="Add Sub_Subcategory"  class="btn btn-success btn-rounded btn-outline">
                    </div>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $data['sub_subcategory']['subcat_name_en']}}</td>
                            <td>{{$data->sub_subcategory_name_en}}</td>
                            <td>{{$data->sub_subcategory_name_hindi}}</td>
