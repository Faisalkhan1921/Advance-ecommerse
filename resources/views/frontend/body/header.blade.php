          ...
          <div class="cnt-account">
            <ul class="list-unstyled">
              ...
              <li>
                ...
                <li>
                  <a ><i class="icon fa fa-user"></i>{{Auth::user()->name}}
                  </a>
                </li>

               <li>
                <a href="{{url('dashboard')}}"> <i class="icon fa fa-lock"></i>Dashboard</a>
               </li>
                      ...
                      <li>
                        <div class="yamm-content ">
                          <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-menu banner-image"> <img class="img-responsive" src="{{asset('frontend/assets/images/banners/top-menu-banner')}}" alt=""> </div>
                            <!-- /.yamm-content --> 
                          </div>
                        </div>
                      </li>
